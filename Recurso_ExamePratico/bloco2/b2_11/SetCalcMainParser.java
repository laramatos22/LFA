...
public class SetCalcMainParser extends Parser {
	...
	public static class StatAssignContext extends StatContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetCalcMainListener ) ((SetCalcMainListener)listener).enterStatAssign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetCalcMainListener ) ((SetCalcMainListener)listener).exitStatAssign(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetCalcMainVisitor ) return ((SetCalcMainVisitor<? extends T>)visitor).visitStatAssign(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprParentContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetCalcMainListener ) ((SetCalcMainListener)listener).enterExprParent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetCalcMainListener ) ((SetCalcMainListener)listener).exitExprParent(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetCalcMainVisitor ) return ((SetCalcMainVisitor<? extends T>)visitor).visitExprParent(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ExprNumbersContext extends ExprContext {
		...
		public ExprNumbersContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetCalcMainListener ) ((SetCalcMainListener)listener).enterExprNumbers(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetCalcMainListener ) ((SetCalcMainListener)listener).exitExprNumbers(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetCalcMainVisitor ) return ((SetCalcMainVisitor<? extends T>)visitor).visitExprNumbers(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprDifferenceContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetCalcMainListener ) ((SetCalcMainListener)listener).enterExprDifference(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetCalcMainListener ) ((SetCalcMainListener)listener).exitExprDifference(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetCalcMainVisitor ) return ((SetCalcMainVisitor<? extends T>)visitor).visitExprDifference(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case T__1:
				{
				_localctx = new ExprNumbersContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
